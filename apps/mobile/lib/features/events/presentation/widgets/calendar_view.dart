  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        // Day grid. Shrink-wrapped and non-scrolling: since Community became
        // one feed the calendar lives *inside* that scroll view, where an
        // `Expanded` has no height to expand into and a nested scrollable
        // would fight the page for the gesture.
        GridView.builder(
          shrinkWrap: true,
            ...
            return GestureDetector(
              onTap: hasEvent
                  ? () {
                      ...
                      context.go(Routes.event(event.id));
                    }
                  : null,
