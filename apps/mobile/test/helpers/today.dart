...
Future<List<Override>> todayOverrides({
  ...
  return [
    ...
    // Back to the real notifier: the baseline fakes it (see
    // [defaultTestOverrides]) because most screens only need «is there a
    // boat», but Today is where remembering *which* boat is the behaviour
    // under test, and this helper supplies the SharedPreferences it reads.
    activeBoatIdProvider.overrideWith(ActiveBoatNotifier.new),
