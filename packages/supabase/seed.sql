...
-- ─── Ports (Mediterranean reference data) ─────────────────────────
INSERT INTO ports (name, location, country, port_type, depth_m, facilities, vhf_channel, website) VALUES
  ('Marina Port de Mallorca', ST_MakePoint(2.6347, 39.5696)::geography, 'ES', 'marina',
    6.0, ARRAY['fuel', 'water', 'electricity', 'wifi', 'showers', 'laundry', 'repair'], '09', 'https://marinaportdemallorca.com'),
  ('Real Club Nautico de Palma', ST_MakePoint(2.6290, 39.5650)::geography, 'ES', 'marina',
    5.0, ARRAY['fuel', 'water', 'electricity', 'wifi', 'showers', 'restaurant', 'repair'], '09', 'https://rcnp.es'),
  ('Port de Soller', ST_MakePoint(2.6920, 39.7950)::geography, 'ES', 'marina',
    4.0, ARRAY['fuel', 'water', 'electricity', 'showers'], '09', NULL),
  ('Port d''Andratx', ST_MakePoint(2.3830, 39.5450)::geography, 'ES', 'marina',
    5.0, ARRAY['fuel', 'water', 'electricity', 'wifi', 'showers', 'restaurant'], '09', NULL),
  ('Club de Mar Mallorca', ST_MakePoint(2.6250, 39.5610)::geography, 'ES', 'marina',
    8.0, ARRAY['fuel', 'water', 'electricity', 'wifi', 'showers', 'restaurant', 'repair', 'crane'], '09', 'https://clubdemar-mallorca.com'),
  ('Marina Ibiza', ST_MakePoint(1.4350, 38.9080)::geography, 'ES', 'marina',
    6.0, ARRAY['fuel', 'water', 'electricity', 'wifi', 'showers', 'restaurant'], '09', 'https://marinaibiza.com'),
  ('Port Olimpic Barcelona', ST_MakePoint(2.2008, 41.3877)::geography, 'ES', 'marina',
    4.5, ARRAY['fuel', 'water', 'electricity', 'wifi', 'showers', 'restaurant', 'repair'], '09', NULL),
  ('Port Vell Barcelona', ST_MakePoint(2.1812, 41.3752)::geography, 'ES', 'marina',
    10.0, ARRAY['fuel', 'water', 'electricity', 'wifi', 'showers', 'restaurant', 'crane'], '09', 'https://marinaportvell.com'),
  ('Port de Cabrera', ST_MakePoint(2.9350, 39.1480)::geography, 'ES', 'anchorage',
    8.0, ARRAY['mooring_buoys'], NULL, NULL),
  ('Cala Figuera', ST_MakePoint(3.1720, 39.3290)::geography, 'ES', 'anchorage',
    5.0, ARRAY[]::text[], NULL, NULL),
  ('Port de Pollenca', ST_MakePoint(3.0830, 39.9030)::geography, 'ES', 'marina',
    3.5, ARRAY['fuel', 'water', 'electricity', 'showers'], '09', NULL),
  ('Port d''Alcudia', ST_MakePoint(3.1280, 39.8380)::geography, 'ES', 'marina',
    4.0, ARRAY['fuel', 'water', 'electricity', 'wifi', 'showers', 'repair'], '09', NULL),
  ('Cala Ratjada', ST_MakePoint(3.4600, 39.7090)::geography, 'ES', 'marina',
    3.0, ARRAY['fuel', 'water', 'electricity'], '09', NULL),
  ('Porto Colom', ST_MakePoint(3.2640, 39.4180)::geography, 'ES', 'marina',
    3.5, ARRAY['fuel', 'water', 'electricity', 'showers'], '09', NULL),
  ('Port de Mahon', ST_MakePoint(4.2660, 39.8860)::geography, 'ES', 'marina',
    6.0, ARRAY['fuel', 'water', 'electricity', 'wifi', 'showers', 'restaurant', 'repair', 'crane'], '12', NULL),
  ('Port de Ciutadella', ST_MakePoint(3.8340, 40.0000)::geography, 'ES', 'marina',
    4.0, ARRAY['fuel', 'water', 'electricity', 'showers', 'restaurant'], '09', NULL),
  ('Marina di Alghero', ST_MakePoint(8.3120, 40.5570)::geography, 'IT', 'marina',
    5.0, ARRAY['fuel', 'water', 'electricity', 'wifi', 'showers', 'restaurant'], '09', NULL),
  ('Port de la Selva', ST_MakePoint(3.2010, 42.3360)::geography, 'ES', 'anchorage',
    6.0, ARRAY['mooring_buoys'], NULL, NULL),
  ('Gasolinera Nautica Palma', ST_MakePoint(2.6380, 39.5670)::geography, 'ES', 'fuel',
